...
# ---------------------------------------------------------------- regions --
LAND_CODES = ("na-w", "na-e", "na-n", "na-av", "ca", "gl", "sa-n", "sa-s", "eu-n", "eu-s", "af-n", "af-e",
...
ALIASES = {
    ...
    "euramerica": ["na-w", "na-e", "na-n", "na-av", "gl", "eu-n", "eu-s"],
    "laurasia": ["na-w", "na-e", "na-n", "na-av", "gl", "eu-n", "eu-s", "as-n", "as-c", "as-ne", "as-s"],
    "holarctic": ["na-w", "na-e", "na-n", "na-av", "gl", "eu-n", "eu-s", "as-n", "as-c", "as-ne", "as-s", "as-w"],
    "gondwana": ["sa-n", "sa-s", "af-n", "af-e", "af-w", "af-s", "mg", "ar", "in", "au-w",
                 "au-e", "ng", "nz", "an", "as-sb"],
    "afro-arabia": ["af-n", "af-e", "af-w", "af-s", "ar"],
    "sahul": ["au-w", "au-e", "ng"],
    "old-world": ["eu-n", "eu-s", "af-n", "af-e", "af-w", "af-s", "ar", "as-w", "as-n", "as-c",
                  "as-ne", "as-s", "as-ic", "as-sb", "in"],
    "new-world": ["na-w", "na-e", "na-n", "na-av", "ca", "sa-n", "sa-s"],
...
LABEL_HOME = {
    ...
    "India": ["in"], "Greater India": ["in"], "Siberia": ["as-n"], "Baltica": ["eu-n"],
    "Avalonia": ["eu-n", "na-av"], "Kazakhstania": ["as-c"], "Amuria": ["as-ne", "as-c", "as-n"],
    ...
    "Rotliegend Desert": ["eu-n"], "Oslo Rift": ["eu-n"], "Zechstein Sea": ["eu-n"],
    "Solnhofen Lagoon": ["eu-s"], "Sveconorwegian Belt": ["eu-n"], "Timanian Belt": ["eu-n"],
    "Hun Superterrane": ["eu-s", "as-w", "as-c"], "Hispanic Corridor": ["ca", "na-e", "af-n", "sa-n"],
    ...
    "Arctic Azolla Bloom": ["arc", "na-n", "gl", "as-n", "eu-n"],
    "Avalon Deep-Water Realm": ["na-av", "eu-n", "iap"], "White Sea Realm": ["eu-n", "au-e"],
    ...
    # Megalonyx on them
    "Caledonides": [{"t": [490, 180], "in": ["eu-n", "gl", "na-e"]}, {"t": [180, 55], "in": ["eu-n", "gl"]},
                    {"t": [55, 0], "in": ["eu-n"]}],
    "Andes": ["sa"], "Himalaya": ["as-c", "in"], "Cordillera": ["na-w", "na-n"],
    "Zagros Mts": ["as-w", "ar"],
    "Ural Mountains": ["eu-n", "as-n"], "Variscan Belt": ["eu"], "Beringia": ["na-n", "as-n"],
    "Beringian Steppe-Tundra": ["na-n", "as-n"], "Arctic Tundra": ["as-n", "eu-n", "na-n"],
    "Eurasian Steppe": ["as-c", "eu-n", "as-n"], "Sahul": ["au", "ng"],
    ...
    "Arctic Ocean": ["arc", "na-n", "gl", "eu-n", "as-n"], "Southern Ocean": ["sou", "an", "sa-s", "nz", "au", "af-s"], "Tethys Ocean": ["tet", "eu", "af-n", "ar", "as-w", "as-c", "in", "as-se", "as-e"],
    ...
    "Iapetus Ocean": ["iap", "na-e", "gl", "eu-n"], "Rheic Ocean": ["rhe", "eu", "af-n", "na-e"],
    "Ural Ocean": ["ura", "eu-n", "as-n", "as-c"], "Mongol-Okhotsk Ocean": ["pan", "as-n", "as-ne"],
    "Piedmont-Ligurian Ocean": ["tet", "eu-s"], "Mozambique Ocean": ["mir", "af-e", "mg", "in"],
    "Adamastor Ocean": ["mir", "sa-s", "af-s"], "Tornquist Sea": ["iap", "eu-n"],
    ...
    "Mediterranean": ["med", "eu-s", "af-n", "as-w"], "Mediterranean (closing)": ["med"],
    "Messinian Salt Basin": ["med", "eu-s", "af-n"],
    "Lago Mare (Messinian Mediterranean)": ["med", "eu-s"],
    ...
    "Okhotsk Sea": ["pac", "as-n"], "Boreal Sea": ["arc", "eu-n", "as-n"],
    "Viking Corridor": ["arc", "atl", "eu-n"], "Turgai Strait": ["tet", "arc", "as-c", "as-n"],
